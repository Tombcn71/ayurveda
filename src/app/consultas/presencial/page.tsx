...
export default function ConsultasPresencialPage() {
  const schemaData = {
    ...
    description:
      "Consultas ayurvédicas presenciales personalizadas con lectura del pulso. Primera consulta 140€, seguimiento 80€.",
    address: {
      "@type": "PostalAddress",
      addressCountry: "ES",
    },
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                <p>
                  En la{" "}
                  <strong>
                    primera consulta presencial de Ayurveda en España
                  </strong>{" "}
                  se realiza una{" "}
            ...
            <motion.div
              ...
              <div className="bg-verde-salvia/10 rounded-3xl p-10 border-2 border-verde-salvia/30 max-w-3xl mx-auto">
                <p className="text-xl text-gray-800 leading-relaxed">
                  Las consultas presenciales están enfocadas en{" "}
                  <strong>
