...
export default function ConsultasPage() {
  const schemaData = {
    ...
    description:
      "Consultas ayurvédicas personalizadas en España con lectura del pulso. Primera consulta presencial 140€, online 125€.",
    address: {
      "@type": "PostalAddress",
      addressCountry: "ES",
    },
          ...
          <div className="container-width relative z-10 text-center px-4">
            <motion.div
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button size="lg" className="text-lg px-8 py-6 bg-[#8c986b]">
          ...
          <div className="container-width px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                <p>
                  En la <strong>primera consulta de Ayurveda en España</strong>{" "}
                  se realiza una{" "}
                  <strong>evaluación completa de tu salud</strong>. Rellenas un
                  cuestionario con tu historial incluyendo alimentación,
                  ejercicio, descanso, gustos, preferencias y se utilizan
                  Técnicas ayurvédicas de diagnóstico.
                </p>

                <div className="bg-emerald-50 border-l-4 border-emerald-500 p-6 rounded-r-lg my-8">
                  <p className="text-gray-800 text-lg">
                    La más importante de estas técnicas es la{" "}
                    <strong>
                      lectura o valoración del pulso ayurvédico -Nadi Vigyam-
                    </strong>{" "}
                    que ofrece muchos beneficios para la salud, nos ayuda a
                    conocer el grado de equilibrio cuerpo-mente y a detectar
                    cualquier desequilibrio, aunque no se haya manifestado como
                    enfermedad.
                  </p>
                </div>
                  ...
                  <Card className="h-full border-emerald-100 hover:border-emerald-300 hover:shadow-xl transition-all">
                    <CardContent className="p-6">
                      <div className="w-14 h-14 bg-[#8c986b] rounded-2xl flex items-center justify-center mb-4">
                        <item.icon className="w-7 h-7 text-white bg-[#8c986b]" />
                      </div>
            ...
            <motion.div
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-3xl p-10 border-2 border-emerald-200 max-w-3xl mx-auto">
                <p className="text-xl text-gray-800 leading-relaxed">
                  Las consultas están enfocadas en{" "}
                  <strong>
                    enseñarte a comprender cómo cuidar de ti mismo
                  </strong>
                  , de modo que no te hagas dependiente del Centro. Nuestra meta
                  es hacer a cada persona{" "}
                  <strong>responsable de su propia salud</strong>.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <motion.div
                ...
                <div className="space-y-6 text-gray-700 leading-relaxed">
                  <p>
                    El <strong>Ayurveda en España</strong> se diferencia de la
                    medicina occidental convencional en que reconoce a cada
                    individuo como un ser único en la naturaleza y tiene en
                    cuenta los desequilibrios que se van acumulando día a día. Y
                    lo reconoce a partir de un único punto de referencia…{" "}
                    <strong>el pulso</strong>.
                  </p>

                  <div className="bg-emerald-50 rounded-xl p-6 border-l-4 border-emerald-500">
                    <h3 className="font-semibold text-emerald-900 mb-3">
                      Evaluación del Pulso Ayurvédico
                    </h3>
                    <p>
                      La <strong>lectura del pulso ayurvédico</strong> es la
                      herramienta que permite evaluar al experto entrenado en
                      Ayurveda, el estado de equilibrio y actividad en el nivel
                      fundamental de la inteligencia biológica. El enfoque está
                      en identificar desequilibrios antes de que se manifiesten
                      como enfermedad.
                    </p>
                  </div>

                  <p>
                    El nivel material de nuestro cuerpo está organizado y
                    dirigido desde el nivel más profundo de la{" "}
                    <strong>inteligencia biológica</strong>. La lectura del
                    pulso permite detectar alteraciones en este nivel
                    fundamental.
                  </p>
                </div>
              </motion.div>
            ...
            <motion.div
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-10 border-2 border-emerald-200 max-w-4xl mx-auto">
                <p className="text-gray-800 text-lg leading-relaxed mb-4">
                  Las enfermedades y los trastornos de salud se producen cuando
                  el flujo libre de estos tres principios se bloquea o se
                  desequilibra. Los mecanismos curativos naturales del cuerpo
                  son más eficaces cuando <strong>Vata, Pitta y Kapha</strong>{" "}
                  están funcionando normalmente.
                </p>
                <p className="text-gray-800 text-lg leading-relaxed">
                  Sobre la base de la <strong>valoración del pulso</strong>, el
                  Consultor de Ayurveda puede determinar si hay un desequilibrio
                  y recomendar el método o tratamiento ayurvédico adecuado.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-8 border border-emerald-200">
                <h3 className="font-serif text-2xl text-gray-900 mb-4">
                  Tipo de constitución cuerpo-mente
                </h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Cada individuo tiene cualidades únicas de digestión,
                  metabolismo, eliminación, masa corporal, estructura ósea y
                  temperamento. Esto es debido a que los niveles de actividad de{" "}
                  <strong>Vata, Pitta y Kapha</strong> varían de un individuo a
                  otro.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  El tipo cuerpo-mente es importante conocerlo, porque determina
                  la{" "}
                  <strong>
                    dieta adecuada, el ejercicio, y la rutina diaria ideal
                  </strong>{" "}
                  para cada individuo. También ayuda a predecir los problemas de
                  salud a la que una persona es propensa.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-8 border border-emerald-200">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Las alteraciones de la salud se deben a los desequilibrios en
                  el nivel de la inteligencia biológica, que son interrupciones
                  en el funcionamiento adecuado de las doshas.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Los métodos recomendados en{" "}
                  <strong>Harit Ayurveda España</strong> incluyen dieta, rutina
                  diaria y estacional, preparados ayurvédicos, Panchakarma,
                  Meditación Trascendental, Yoga y Aromas… todos diseñados para{" "}
                  <strong>restablecer el equilibrio</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container-width px-4 relative z-10">
            <motion.div
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-3xl p-10 border border-white/20">
                  <h3 className="text-2xl font-serif text-white mb-6">
                    Consulta de Seguimiento (30 min)
                  </h3>
                  <div className="space-y-4">
                    <div>
                      <div className="text-5xl font-bold text-white mb-2">
