  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden pt-24">
          ...
          <div className="container-width relative z-10 text-center px-4">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              <div className="inline-flex items-center gap-2 px-5 py-2 bg-teal-500/20 backdrop-blur-sm rounded-full mb-6 border border-teal-300/30">
                <Leaf className="w-4 h-4 text-teal-300" />
                <span className="text-teal-100 font-semibold text-sm uppercase tracking-wider">14 Días de Transformación</span>
              </div>
        ...
        <section className="py-20 bg-gradient-to-b from-teal-50/30 to-white">
          <div className="container-width px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              {benefits.map((benefit, index) => (
                <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }}>
                  <Card className="h-full border-teal-100 hover:border-teal-300 hover:shadow-xl transition-all">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center">
              <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-3xl p-10 border-2 border-teal-200 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
              {workshops.map((workshop, index) => (
                <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }}>
                  <Card className="border-teal-100 hover:border-teal-300 hover:shadow-lg transition-all">
                    <CardContent className="p-6 text-center">
                      <Calendar className="w-8 h-8 text-teal-600 mx-auto mb-3" />
                      <p className="font-semibold text-gray-900 mb-1">{workshop.date}</p>
                      <p className="text-teal-600 font-bold text-xl">{workshop.time}</p>
                    </CardContent>
                  </Card>
                </motion.div>
              ))}
        ...
        <section className="py-20 bg-gradient-to-br from-teal-600 to-cyan-700 relative">
          ...
          <div className="container-width px-4 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-10 border border-white/20 mb-10">
                ...
                <div className="text-teal-100 text-xl mb-2">Programa Detox de 14 días</div>
                <div className="text-sm text-teal-200 mb-6">*Gastos de envío no incluidos</div>
                ...
                <div className="border-t border-white/20 pt-6 mt-6">
                  <p className="text-teal-100 text-lg mb-4">Charla Informativa Gratuita Online</p>
