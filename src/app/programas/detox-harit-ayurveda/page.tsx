...
export default function DetoxHaritAyurvedaPage() {
  const schemaData = {
    ...
    description:
      "Programa de desintoxicación ayurvédica de 14 días en España. Limpieza estacional completa con plantas ayurvédicas.",
    provider: {
          ...
          <div className="container-width relative z-10 text-center px-4">
            <motion.div
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button
                  size="lg"
                  className="text-lg px-8 py-6 bg-[#8c986b] text-white"
                  onClick={() => {
          ...
          <div className="container-width px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                <p>
                  Nuestro <strong>Detox Harit Ayurveda en España</strong>{" "}
                  consiste en una{" "}
                  <strong>
                    limpieza estacional a base de plantas ayurvédicas
                    certificadas
                  </strong>{" "}
                  y alimentación consciente. Utilizamos el ritmo de la
                  naturaleza para activar específicamente los órganos de
                  desintoxicación del cuerpo con preparados ayurvédicos a base
                  de plantas.
                </p>

                <p>
                  Se puede realizar{" "}
                  <strong>cómodamente desde casa en España</strong> y puede
                  compatibilizarse incluso con tu trabajo.
                </p>

                <div className="bg-[#8c986b]/10 border-l-4 border-[#8c986b] p-6 rounded-r-lg my-8">
                  <p className="text-gray-800 text-lg">
                    Esta suave experiencia de{" "}
                    <strong>desintoxicación de 2 semanas</strong> te ayudará a
                    equilibrar el azúcar y limpiar el sistema linfático; y
                    restablecer el metabolismo y la digestión natural de las
                    grasas. Te sentirás más fuerte, más clar@ y preparad@ para
                    enfrentar cualquier cosa que se te presente.
                  </p>
                </div>
              </div>
            </div>
              ...
              <motion.div
                ...
                <div className="space-y-6 text-gray-700 leading-relaxed">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#8c986b]/20 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p>
                        A diferencia de muchas otras limpiezas, con el{" "}
                        <strong>Detox Harit Ayurveda</strong> NO provocará
                        caídas de azúcar en la sangre o antojos de comida.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#8c986b]/20 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Users className="w-6 h-6 text-[#8c986b]" />
                    </div>
                    <div>
                      <p className="font-semibold text-gray-900 mb-2">
                        Apoyo constante
                      ...
                      <p>
                        5 workshops online en directo + grupo de apoyo en
                        WhatsApp para resolver dudas y compartir experiencias.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-[#8c986b]/20 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Heart className="w-6 h-6 text-[#8c986b]" />
                    </div>
                    <div>
                      <p className="font-semibold text-gray-900 mb-2">
                      ...
                      <p>
                        Contarás con el apoyo y la experiencia de{" "}
                        <strong>
                          Pilar Franco de Sarabia y Bhavani Cordero
                        </strong>{" "}
          ...
          <div className="container-width px-4">
            <motion.div
              ...
              <p className="text-xl text-gray-600">
                Resultados reales con nuestro programa en España
              </p>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                <div className="space-y-6">
                  <div className="bg-[#8c986b]/10 rounded-2xl p-6">
                    <h3 className="font-semibold text-xl text-gray-900 mb-4 flex items-center gap-2">
                      <Video className="w-6 h-6 text-[#8c986b]" />5 Workshops
                      Interactivos por Zoom
                    </h3>
        ...
        <section className="py-20 bg-gradient-to-b from-emerald-50/30 to-white">
          <div className="container-width px-4">
            <motion.div
              ...
              <p className="text-xl text-gray-600">
                Todos en vivo por Zoom a las 20:00h
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              <p className="text-gray-600">
                Si no puedes asistir en vivo, recibirás el enlace a la grabación
                al día siguiente
              </p>
            </motion.div>
          </div>
          ...
          <div className="container-width px-4 relative z-10">
            <motion.div
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-10 border border-white/20 mb-10">
                ...
                <div className="text-emerald-100 text-xl mb-2">
                  Programa Detox de 14 días
                </div>
                <div className="text-sm text-emerald-200 mb-6">
                  *Gastos de envío no incluidos
                </div>
                <div className="text-sm text-emerald-200 mb-8">
                  20% de descuento en productos si ya has hecho un Detox con
                  nosotros
                </div>
                <Button
                  size="lg"
              ...
              <p className="text-emerald-50 leading-relaxed">
                Si vives fuera de España o Portugal, contacta con nosotros para
                más información sobre envíos y opciones de pago.
              </p>
            </motion.div>
          </div>
        </section>
