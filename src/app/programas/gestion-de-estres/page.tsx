...
export default function GestionDelEstresPage() {
  const schemaData = {
    ...
    description:
      "Programa ayurvédico en España para gestionar estrés, ansiedad y depresión con tratamiento natural holístico",
    provider: {
          ...
          <div className="container-width relative z-10 text-center px-4">
            <motion.div
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 max-w-3xl mx-auto mb-8 leading-relaxed">
                Programa ayurvédico integral en España para superar ansiedad,
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 text-lg leading-relaxed mb-6">
                  <strong>
                    Depresión, ansiedad, soledad, insomnio, hábitos alimenticios
                    poco saludables, aprensión al fracaso, falta de voluntad,
                    abuso de sustancias tóxicas, pensamientos suicidas.
                  </strong>{" "}
                  Todos estos son el resultado de factores estresantes.
                </p>

                <p className="text-gray-700 text-lg leading-relaxed mb-6">
                  El <strong>estrés en España</strong> puede ser causado por
                  múltiples factores y termina llevándonos a{" "}
                  <strong>trastornos crónicos</strong> como hipertensión,
                ...
                <div className="bg-verde-salvia/10 border-l-4 border-verde-salvia p-6 rounded-r-lg my-8">
                  <p className="text-gray-800 text-lg italic">
                    El{" "}
                    <strong>
                      Programa Gestión del Estrés de Harit Ayurveda en España
                    </strong>{" "}
                    te brinda un enfoque integral y natural para aprender a
          ...
          <div className="container-width px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Conexión mente-cuerpo Ayurveda"
                    fill
              ...
              <motion.div
                ...
                viewport={{ once: true }}>
                <h2 className="font-serif text-4xl md:text-5xl text-gray-900 mb-6">
                  Comprensión ayurvédica del estrés
                </h2>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Desde una perspectiva ayurvédica no podemos separar el
                    cuerpo de la mente. Ambos deben estar en equilibrio para
                    experimentar una salud óptima.
                  </p>
                  <p>
                    En <strong>Ayurveda en España</strong> trabajamos la mente
                    haciendo que el cuerpo vaya adquiriendo más estabilidad,
                    flexibilidad y fortaleza.
                  </p>
                  <p>
                    En nuestro{" "}
                    <strong>Programa Gestión del estrés en España</strong> se
                    trata cuerpo-mente de forma holística con evaluación
                    personalizada.
                  </p>
                </div>
              </motion.div>
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="flex gap-1 mb-3">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className="w-4 h-4 fill-amber-400 text-emerald-400"
                          />
                        ))}
                      </div>
          ...
          <div className="container-width px-4 relative z-10">
            <motion.div
              ...
              <p className="text-xl text-emerald-50 leading-relaxed mb-8">
                Tu primer acercamiento al <strong>Ayurveda en España</strong>{" "}
                para resolver problemas de depresión, ansiedad o agotamiento.
              </p>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-10 border border-white/20 mb-10">
                ...
                <div className="text-emerald-100 text-lg mb-4">
                  Primera Consulta Ayurvédica
                </div>
                <div className="text-sm text-emerald-200 mb-6">
                  *Esta cantidad se restará del programa completo
                </div>
                <Button
                  size="lg"
                  variant="hero"
