...
export default function PagoMeditacion() {
  return (
    <>
      <Header />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Inscripción - Curso de Meditación Trascendental
            </h1>
            <p className="text-gray-600">
              Completa tu inscripción al curso de meditación trascendental
            </p>
          </div>
          ...
          <Card className="p-8 mb-8">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 mb-4">4 sesiones + 6 meses de seguimiento</p>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-verde-salvia flex-shrink-0 mt-0.5" />
                    <span>Instrucción personal (Día 1)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-verde-salvia flex-shrink-0 mt-0.5" />
                    <span>3 sesiones grupales</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-verde-salvia flex-shrink-0 mt-0.5" />
                    <span>6 meses de seguimiento incluido</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 pt-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="text-3xl font-bold text-verde-salvia">Desde 390€</span>
              </div>
              <p className="text-sm text-gray-600 mb-6">
                El precio varía según tus ingresos mensuales. Contacta con nosotros para más información.
              </p>
