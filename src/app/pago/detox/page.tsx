...
export default function PagoDetox() {
  return (
    <>
      <Header />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Inscripción - Detox Harit Ayurveda
            </h1>
            <p className="text-gray-600">
              Completa tu inscripción al programa de desintoxicación de 14 días
            </p>
          </div>
          ...
          <Card className="p-8 mb-8">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">
                  Programa Detox Harit Ayurveda
                </h2>
                <p className="text-gray-600 mb-4">14 días de transformación</p>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-verde-salvia flex-shrink-0 mt-0.5" />
                    <span>Programa completo de limpieza estacional</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-verde-salvia flex-shrink-0 mt-0.5" />
                    <span>Guía detallada y seguimiento</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-verde-salvia flex-shrink-0 mt-0.5" />
                    <span>Preparados ayurvédicos incluidos</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 pt-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="text-3xl font-bold text-verde-salvia">275€</span>
              </div>
