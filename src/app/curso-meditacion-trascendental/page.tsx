            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-10 border border-white/20 mb-10">
                <div className="mb-8">
                  ...
                  <p className="text-emerald-100">Harit Ayurveda • Madrid, España</p>
                </div>

                <div className="border-t border-white/20 pt-8 mb-8">
                  <p className="text-emerald-100 text-lg mb-4">Próximas fechas</p>
                ...
                <div className="border-t border-white/20 pt-8">
                  <p className="text-emerald-100 text-lg mb-4">Contacto e Información</p>
                  <a href="tel:+34664462368" className="text-white text-4xl font-bold hover:text-emerald-200 transition-colors inline-block mb-4">
                    +34 664 46 23 68
                  </a>
                  <p className="text-emerald-100 text-sm">(WhatsApp o teléfono)</p>
                </div>
              </div>
