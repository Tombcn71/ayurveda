...
const cursoSteps = [
  {
    ...
    description:
      "Aprenderás la técnica básica de la MT con un profesor cualificado. Podrás practicarla por tu cuenta en casa.",
  },
  {
    day: "Día 2 - Martes",
    title: "Sesión Grupal",
    ...
    description:
      "Primera sesión en grupo donde se perfecciona la técnica y obtienes comprensión más clara.",
  },
  {
    day: "Día 3 - Miércoles",
    title: "Sesión Grupal",
    duration: "19:00 a 21:00",
    description:
      "Continuación del perfeccionamiento de la técnica con práctica guiada.",
  },
  {
    day: "Día 4 - Jueves",
    ...
    duration: "19:00 a 21:00",
    description:
      "Última sesión que te capacita para meditar cómodamente en tu vida cotidiana.",
  },
];
...
export default function CursoMeditacionPage() {
  const schemaData = {
    ...
    description:
      "Aprende Meditación Trascendental en 4 sesiones con 6 meses de seguimiento en Madrid, España",
    provider: {
      "@type": "Organization",
          ...
          <div className="container-width px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                <p>
                  La técnica de la{" "}
                  <strong>Meditación Trascendental en Madrid</strong> se aprende
                  fácilmente en un <strong>curso de siete pasos</strong>{" "}
                  enseñado por profesores cualificados. El Curso continúa
                  durante <strong>6 meses de seguimiento regular</strong> de las
                  experiencias por parte del profesor en sesiones de chequeo y
                ...
                <div className="bg-[#8c986b]/10 border-l-4 border-[#8c986b] p-6 rounded-r-lg my-8">
                  <p className="text-gray-800 text-lg">
                    ...
                    casa o cualquier lugar que sea suficientemente confortable.
                  </p>
                </div>

                <p>
                  Una vez que completes el curso podrás continuar tu práctica
                  diaria de forma autosuficiente sin tener que depender de
                  nadie, pero siempre tendrás nuestro apoyo en{" "}
                  <strong>Harit Ayurveda España</strong>.
                </p>
              </div>
          ...
          <div className="container-width px-4">
            <motion.div
              ...
              <p className="text-xl text-gray-600">
                4 sesiones consecutivas de lunes a jueves
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="bg-[#8c986b]/10 rounded-3xl p-10 border-2 border-[#8c986b]/30 max-w-3xl mx-auto">
                ...
                <p className="text-gray-700">
                  El curso de MT es totalmente personalizado para garantizar tu
          ...
          <div className="container-width px-4">
            <motion.div
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Nuestra Asociación Ayuseduca es sin ánimo de lucro. No queremos
                que nadie se quede sin aprender por motivos económicos.
              </p>
            </motion.div>
          ...
          <div className="container-width px-4 relative z-10">
            <motion.div
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-10 border border-white/20 mb-10">
                <div className="mb-8">
                  <p className="text-emerald-100 text-xl mb-2">Imparte:</p>
                  <p className="text-white text-3xl font-bold mb-4">
                    Pilar Franco de Sarabia
                  </p>
                  <p className="text-emerald-100">
                    Harit Ayurveda • Madrid, España
                  </p>
                </div>
                ...
                <div className="border-t border-white/20 pt-8 mb-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-center gap-2 text-white text-lg">
                      ...
                      <span>
                        Duración: 4 días consecutivos (Lunes a Jueves)
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t border-white/20 pt-8">
                  ...
                  <a
                    href="tel:+34664462368"
                    className="text-white text-4xl font-bold hover:text-emerald-200 transition-colors inline-block mb-4">
                    +34 664 46 23 68
                  </a>
              ...
              <p className="text-emerald-100 leading-relaxed">
                Para consulta de próximas fechas no dudes en contactarnos a
                través de nuestros canales de comunicación. Te esperamos.
              </p>
            </motion.div>
          </div>
        </section>
