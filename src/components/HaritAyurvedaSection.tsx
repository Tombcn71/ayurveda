...
export const HaritAyurvedaSection = () => {
  ...
  return (
    <>
      ...
      <section
        id="harit-ayurveda"
        className="relative py-24 overflow-hidden bg-gradient-to-b from-white via-emerald-50/20 to-white">
        <div className="container-width relative z-10">
          ...
          <motion.div
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-6 text-sm font-medium text-primary bg-sage-light/60 rounded-full animate-fade-up">
              ...
              <span>Ayurveda para tu bienestar</span>
            </div>

            <h2 className="font-serif text-2xl md:text-3xl text-gray-900 mb-6 leading-tight px-4 sm:px-6">
              <span className="block md:inline">Tu espacio de Ayurveda,</span>{" "}
              <span className="block md:inline">
                salud natural y bienestar holístico.
              </span>
            </h2>

            <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-10 px-4 sm:px-6">
              Ofrecemos: Consultas ayurvédicas con lectura del pulso y dieta
              personalizada, Programas Detox y de Rejuvenecimiento, Cosmética
              natural certificada, Complementos nutricionales ayurvédicos y
              Cursos de Meditación Trascendental para la gestión del estrés.
              Todo desde una mirada consciente, integrativa y profundamente
              humana.
            </p>
          </motion.div>
              ...
              <div className="relative h-full bg-white rounded-3xl p-10 transition-all duration-500 border-2 border-[#869266]/30 hover:border-[#869266]">
                <div className="relative">
                  ...
                  <h3 className="font-serif text-3xl text-gray-900 mb-6 leading-tight">
                    Qué es <br />
                    <span className="text-[#869266]">Harit Ayurveda</span>
                  </h3>

                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <p>
                      Harit nace desde una visión holística del bienestar,
                      integrando cuerpo, mente y alma a través del Ayurveda, la
                      ciencia milenaria de la vida. Inspirado en Harita, la
                      fuerza nutritiva de la naturaleza, propone una forma
                      consciente y profunda de cuidarse y vivir mejor.
                    </p>

                    <p>
                      <strong className="text-gray-900">LA ESENCIA</strong> de
                      Harit es <strong>Nutrir</strong>… no solo cuerpo, sino
                      mente, intelecto, sentidos, alma.
                    </p>

                    <p>
                      <strong className="text-gray-900">VISIÓN:</strong>{" "}
                      Transformarnos poco a poco para alcanzar el equilibrio
                      perfecto entre cuerpo, mente y alma. Teniendo una visión
                      de la meta, pero disfrutando del camino, del aquí y el
                      ahora.
                    </p>

                    <p>
                      <strong className="text-gray-900">META:</strong> Crear
                      salud y bienestar a nivel individual, social, empresarial,
                      educativo y medioambiental a través de la sabiduría del
                      Ayurveda, avalada por miles de años de experiencia y
                      validada por la investigación y tecnología.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <motion.div
              ...
              <div className="relative h-full bg-white rounded-3xl p-10 transition-all duration-500 border-2 border-[#e0b126]/30 hover:border-[#e0b126]">
                <div className="relative">
                  ...
                  <h3 className="font-serif text-3xl text-gray-900 mb-6 leading-tight">
                    A quién <br />
                    <span className="text-[#e0b126]">ayudamos</span>
                  </h3>

                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <p>
                      Nuestros{" "}
                      <strong>tratamientos de Harit Ayurveda en España</strong>{" "}
                      benefician a personas de todas las edades que buscan{" "}
                      <strong>mejorar su salud naturalmente</strong>. Ayudamos
                      especialmente a quienes sufren de:
                    </p>
                    ...
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          <strong>Estrés crónico y ansiedad</strong> en España
                        </span>
                      </li>
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          <strong>Problemas digestivos</strong> (gastritis,
                          colon irritable)
                        </span>
                      </li>
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          <strong>Desequilibrios hormonales</strong> y
                          menopausia
                        </span>
                      </li>
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          <strong>Fatiga crónica e insomnio</strong>
                        </span>
                      </li>
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          <strong>Problemas de piel</strong> (eczema, psoriasis,
                          acné)
                        </span>
                      </li>
                    </ul>
                    ...
                    <p className="text-sm text-gray-600 italic mt-4">
                      Nuestros{" "}
                      <strong>especialistas certificados en Ayurveda</strong>{" "}
                      adaptan cada tratamiento a tu constitución única
                      (prakriti) y estilo de vida en España.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <motion.div
              ...
              <div className="relative h-full bg-white rounded-3xl p-10 transition-all duration-500 border-2 border-[#ba9fb7]/30 hover:border-[#ba9fb7]">
                <div className="relative">
                  ...
                  <h3 className="font-serif text-3xl text-gray-900 mb-6 leading-tight">
                    Qué problema <br />
                    <span className="text-[#ba9fb7]">resolvemos</span>
                  </h3>
                  ...
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <p>
                      ...
                      aborda la{" "}
                      <strong>raíz de los desequilibrios de salud</strong>, no
                      solo los síntomas superficiales. Resolvemos mediante{" "}
                      <strong>diagnósticos personalizados</strong>:
                    </p>
                    ...
                    <ul className="space-y-3 text-gray-700">
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          <strong>Fortalecimiento del sistema inmune</strong>{" "}
                          naturales
                        </span>
                      </li>
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          <strong>Regulación del sueño y la energía</strong> con
                          Ayurveda
                        </span>
                      </li>
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span>
                          <strong>
                            Mayor claridad mental y conexión interior
                          </strong>
                        </span>
                      </li>
                    </ul>
                    ...
                    <p className="text-sm text-gray-600 italic mt-4">
                      Incluye{" "}
                      <strong>
                        planes nutricionales específicos para tu dosha
                      </strong>
                      , <strong>terapias Panchakarma de desintoxicación</strong>
                      , suplementos herbales certificados y prácticas de
                      mindfulness que fortalecen tu{" "}
                      <strong>
                        sistema inmunológico naturalmente en España
                      </strong>
                      .
                    </p>
                  </div>
